...
<style>
  ...
  h1 { color:#38bdf8; margin:0 0 1.5rem 0; font-size:1.8rem; }
  ...
  .badge { display:inline-block; margin-top:1.5rem; background:#0ea5e9; color:#04121f; padding:0.35rem 1rem; border-radius:999px; font-size:0.8rem; font-weight:700; }
</style>
</head>
<body>
  <div class="card">
    ...
    <div class="badge">Lab 2 · Load Balancer</div>
  </div>
</body>
</html>
HTML
